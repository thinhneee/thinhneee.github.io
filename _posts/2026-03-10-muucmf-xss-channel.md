---
title: 	Muucmf T6 CMS contains Reflected XSS in /channel/admin.Account/autoReply.html?keyword=
...
![img-description](./assets/muucmf_poc/XSS_POC3.png)

## 3. POC

Inject XSS payload to endpoint `http://127.0.0.1/channel/admin.Account/autoReply.html?keyword=` and the payload will execute.

![img-description](./assets/muucmf_poc/XSS_POC4.png)

**Video demo:**

{% include embed/youtube.html id='OsVySoXaEZU' %}
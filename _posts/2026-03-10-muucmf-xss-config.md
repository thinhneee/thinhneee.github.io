---
title: 	Muucmf T6 CMS contains Reflected XSS in /admin/config/list.html?name=
...
![img-description](./assets/muucmf_poc/XSS_POC5.png)

## 3. POC

Inject XSS payload to endpoint `http://127.0.0.1/admin/config/list.html?name=` and the payload will execute.

![img-description](./assets/muucmf_poc/XSS_POC6.png)

**Video demo:**

{% include embed/youtube.html id='dYCF1MiZz9Q' %}
